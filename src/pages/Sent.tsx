    ...
    return (
      <div className="h-full flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-400">Loading sent messages...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="h-full flex flex-col p-5 lg:p-8">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-cyan-300">Sent</h1>
          <p className="text-xs text-gray-500">
            {emails.length} message{emails.length !== 1 ? 's' : ''} sent
          </p>
        </div>
      </div>
      ...
      {emails.length === 0 ? (
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-500 text-sm">No sent messages yet</p>
          </div>
        </div>
      ) : (
